...
urlpatterns = [
    ...
    path("live-face-analysis/", views.live_face_analysis, name="live_face_analysis"),
    path("face-analysis/", views.live_face_analysis_view, name="face_analysis"),
    path("math-solver/", views.Math_solver, name="math_solver"),
    path("solve-math/", views.solve_math, name="solve-math"),  # API for chatbot
]